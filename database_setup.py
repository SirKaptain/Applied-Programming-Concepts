...
def populate_students(conn):
    data = pd.read_csv ('./initial_student_table.csv')   
...
def populate_instructors(conn):
    data = pd.read_csv ('./initial_instructor_table.csv')   
    df = pd.DataFrame(data)
    cur = conn.cursor()
    for row in df.itertuples():
...
def populate_admins(conn):
    data = pd.read_csv ('./initial_admin_table.csv')   
    df = pd.DataFrame(data)
    cur = conn.cursor()
    for row in df.itertuples():
...
def populate_courses(conn):
    data = pd.read_csv ('./initial_courses_table.csv')   
    df = pd.DataFrame(data)
    cur = conn.cursor()
    for row in df.itertuples():
...
def populate_login(conn):
    data = pd.read_csv ('./initial_login_table.csv')   
    df = pd.DataFrame(data)
    cur = conn.cursor()
    for row in df.itertuples():
